...
public abstract class ServletBase extends HttpServlet {
  ...
  public String getHTML(final HttpServletRequest req) throws Throwable {
    if (html==null){
      html = Utility.loadResourceAsString("aces/webctrl/cli/resources/"+getClass().getSimpleName()+".html")
      .replace("href=\"../../../../../root/webapp/main.css\"", "href=\"main.css\"")
      .replace("__DOCUMENTATION__", "https://github.com/automatic-controls/cli-addon");
    }
